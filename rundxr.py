...
net.setIntfIp('h4','s1','12.36.123.58/24')
net.setIntfIp('h5','s1','12.36.123.240/24')
net.setIntfIp('h6','s1','12.36.123.105/24')
net.setIntfIp('h7','s1','12.36.123.180/24')
net.setIntfIp('h8','s1','12.36.123.137/24')
...
net.setDefaultRoute('h4', '12.36.123.58')
net.setDefaultRoute('h5', '12.36.123.240')
net.setDefaultRoute('h6', '12.36.123.105')
net.setDefaultRoute('h7', '12.36.123.180')
net.setDefaultRoute('h8', '12.36.123.137')
